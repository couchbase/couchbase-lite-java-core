 ...
 * operations invokving SQLite can throw {@link com.couchbase.lite.internal.database.sqlite.exception.SQLiteException} or other
...
public final class SQLiteConnectionPool implements Closeable {
    ...
    private SQLiteConnectionPool(com.couchbase.lite.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
     ...
     *
     * @throws com.couchbase.lite.internal.database.sqlite.exception.SQLiteException if a database error occurs.
     */
    public static SQLiteConnectionPool open(com.couchbase.lite.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
                                            com.couchbase.lite.internal.database.sqlite.SQLiteConnectionListener connectionListener) {
     ...
     * @throws IllegalStateException if the pool has been closed.
     */
    public void reconfigure(com.couchbase.lite.internal.database.sqlite.SQLiteDatabaseConfiguration configuration) {
        if (configuration == null) {
            throw new IllegalArgumentException("configuration must not be null.");
        }
    ...
    // Might throw.
    private SQLiteConnection openConnectionLocked(com.couchbase.lite.internal.database.sqlite.SQLiteDatabaseConfiguration configuration,
