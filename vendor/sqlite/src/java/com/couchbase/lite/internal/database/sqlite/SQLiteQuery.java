...
public final class SQLiteQuery extends SQLiteProgram {
    ...
    SQLiteQuery(com.couchbase.lite.internal.database.sqlite.SQLiteDatabase db, String query, CancellationSignal cancellationSignal) {
        super(db, query, null, cancellationSignal);

        mCancellationSignal = cancellationSignal;
    }

    com.couchbase.lite.internal.database.sqlite.SQLiteConnection.PreparedStatement beginQuery() {
        acquireReference();
        try {
    ...
    void endQuery(com.couchbase.lite.internal.database.sqlite.SQLiteConnection.PreparedStatement statement) {
        acquireReference();
        try {
