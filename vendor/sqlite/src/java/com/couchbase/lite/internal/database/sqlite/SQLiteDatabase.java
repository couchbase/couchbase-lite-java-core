...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private final com.couchbase.lite.internal.database.sqlite.SQLiteDatabaseConfiguration mConfigurationLocked;
     ...
     */
    public void beginTransactionWithListener(com.couchbase.lite.internal.database.sqlite.SQLiteTransactionListener transactionListener) {
    ...
    public void beginTransactionWithListenerNonExclusive(
            com.couchbase.lite.internal.database.sqlite.SQLiteTransactionListener transactionListener) {
        beginTransaction(transactionListener, false);
    }

    private void beginTransaction(com.couchbase.lite.internal.database.sqlite.SQLiteTransactionListener transactionListener,
                                  boolean exclusive) {
        acquireReference();
        try {
     ...
     *
     * @throws com.couchbase.lite.internal.database.sqlite.exception.SQLiteException if the database could not be reopened as requested, in which
     ...
     * statement and fill in those values with {@link com.couchbase.lite.internal.database.sqlite.SQLiteProgram#bindString}
     * and {@link com.couchbase.lite.internal.database.sqlite.SQLiteProgram#bindLong} each time you want to run the
     * statement. Statements may not return result sets larger than 1x1.
     *<p>
     * No two threads should be using the same {@link com.couchbase.lite.internal.database.sqlite.SQLiteStatement} at the same time.
     *
     * @param sql The raw SQL statement, may contain ? for unknown values to be
     *            bound later.
     * @return A pre-compiled {@link com.couchbase.lite.internal.database.sqlite.SQLiteStatement} object. Note that
     * {@link com.couchbase.lite.internal.database.sqlite.SQLiteStatement}s are not synchronized, see the documentation for more details.
     */
    public com.couchbase.lite.internal.database.sqlite.SQLiteStatement compileStatement(String sql) throws SQLException {
        acquireReference();
        try {
            return new com.couchbase.lite.internal.database.sqlite.SQLiteStatement(this, sql, null);
        } finally {
            releaseReference();
        }
    }
    ...
    public long insertWithOnConflict(String table, String nullColumnHack,
        ...
        try {
            ...
            com.couchbase.lite.internal.database.sqlite.SQLiteStatement statement = new com.couchbase.lite.internal.database.sqlite.SQLiteStatement(this, sql.toString(), bindArgs);
            try {
    ...
    private int executeSql(String sql, Object[] bindArgs) throws SQLException {
        ...
        try {
            ...
            com.couchbase.lite.internal.database.sqlite.SQLiteStatement statement = new com.couchbase.lite.internal.database.sqlite.SQLiteStatement(this, sql, bindArgs);
            try {
                return statement.executeUpdateDelete();
            } finally {
                statement.close();
     ...
     * {@link #beginTransactionWithListenerNonExclusive(com.couchbase.lite.internal.database.sqlite.SQLiteTransactionListener)}
     ...
     * Used by bug report.
     */
    static ArrayList<com.couchbase.lite.internal.database.sqlite.SQLiteDebug.DbStats> getDbStats() {
        ArrayList<com.couchbase.lite.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList = new ArrayList<com.couchbase.lite.internal.database.sqlite.SQLiteDebug.DbStats>();
    ...
    private void collectDbStats(ArrayList<com.couchbase.lite.internal.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
        synchronized (mLock) {
    ...
    public boolean isDatabaseIntegrityOk() {
        ...
        try {
            ...
            } catch (com.couchbase.lite.internal.database.sqlite.exception.SQLiteException e) {
            ...
            for (int i = 0; i < attachedDbs.size(); i++) {
                ...
                com.couchbase.lite.internal.database.sqlite.SQLiteStatement prog = null;
                try {
    ...
    public interface CursorFactory {
        public Cursor newCursor(SQLiteDatabase db,
                                com.couchbase.lite.internal.database.sqlite.SQLiteCursorDriver masterQuery, String editTable,
                                SQLiteQuery query);
    }
