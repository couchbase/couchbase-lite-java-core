...
import com.couchbase.lite.database.cursor.Cursor;
import com.couchbase.lite.database.DatabaseErrorHandler;
import com.couchbase.lite.database.DefaultDatabaseErrorHandler;
import com.couchbase.lite.database.SQLException;
...
import com.couchbase.lite.database.sqlite.exception.SQLiteException;
import com.couchbase.lite.database.util.DatabaseUtils;
import com.couchbase.lite.database.log.Log;
import com.couchbase.lite.database.OperationCanceledException;
import com.couchbase.lite.database.util.Pair;
import com.couchbase.lite.database.util.Printer;
import com.couchbase.lite.database.util.TextUtils;
...
public final class SQLiteDatabase extends SQLiteClosable {
    private static final String TAG = Log.TAG_SQLiteDatabase;
    ...
    private SQLiteDatabase(String path, int openFlags, CursorFactory cursorFactory,
            DatabaseErrorHandler errorHandler, SQLiteConnectionListener connectionListener) {
